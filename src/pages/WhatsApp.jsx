...
export default function WhatsApp() {
  ...
  const sendAttachment = async (event) => {
    ...
    if (!active.lead_id) {
      toast.error("Attachments can only be sent to a conversation linked to a CRM lead.");
      return;
    }
